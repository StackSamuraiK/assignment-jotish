    ...
    if (!employees) {
      const fetchData = async () => {
        try {
          ...
          const items = rawData.map((empArray: any[], index: number) => ({
            name: empArray[0],
            role: empArray[1],
            city: empArray[2],
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col pb-12">
      <header className="bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between sticky top-0 z-[1000] shadow-sm">
        ...
        <button 
          ...
          className="bg-slate-900 text-white px-4 py-2 rounded-lg font-bold hover:bg-black transition-all flex items-center gap-2"
        >
